...
from utils.process_time import ProcessData
...
if __name__=="__main__":
    ...
    variable
    ["ARO2-DCS-FI91601", "ARO2-LIMS-S905@Water", "ARO2-LIMS-S907@Water", "ARO2-DCS-R911_2_A_FA", "ARO2-DCS-R911_2_L2_A"]
    modify = None
    ...
    path = "data/R911R912_R4-ARO2.xlsx"
    target = ["ARO2-DCS-PDI91101"]
    time = ["time"]
    ...
    if ("process_{target}_data.csv".format(target = target[0]) not in os.listdir("result/data/")) | (update):
        process_data = ProcessData(path = path, target = target, time = time, variable = variable, method = method, remove_FI91601_value = remove_FI91601_value)
